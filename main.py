...
if __name__ == '__main__':
    ...
    if not kind == 'NoOperation':
        ...
        save_csv(bess_powers,f'bess_powers_{kind}_year{name_dss.split('.')[0]}',output_csv + 'bess/')
    ...
    #         # Save the results in a csv file
    #         if not kind == 'NoOperation':
    #             save_csv(bus_power,f'bus_power_{kind}_bus{bess_bus}_year',output_csv + 'bus_power/')
    #             save_csv(load_df,f'load_{kind}_bus{bess_bus}_year',output_csv + 'load/')
    #             save_csv(generation_df,f'generation_{kind}_bus{bess_bus}_year',output_csv + 'generation/')
    #             save_csv(demand_df,f'demand_{kind}_bus{bess_bus}_year',output_csv + 'demand/')
    #             save_csv(losses_df,f'losses_{kind}_bus{bess_bus}_year',output_csv + 'losses/')
    #             save_csv(branch_df,f'branch_df_{kind}_bus{bess_bus}_year',output_csv + 'branch_flows/')
    #             save_csv(bus_voltage_df,f'bus_voltage_df_{kind}_bus{bess_bus}_year',output_csv + 'bus_voltage/')
    #             save_csv(bess_powers,f'bess_powers_{kind}_bus{bess_bus}_year',output_csv + 'bess/')
    #         else:
    #             save_csv(bus_power,f'bus_power_{kind}_year',output_csv + 'bus_power/')
    #             save_csv(load_df,f'load_{kind}_year',output_csv + 'load/')
    #             save_csv(generation_df,f'generation_{kind}_year',output_csv + 'generation/')
    #             save_csv(demand_df,f'demand_{kind}_year',output_csv + 'demand/')
    #             save_csv(losses_df,f'losses_{kind}_year',output_csv + 'losses/')
    #             save_csv(branch_df,f'branch_df_{kind}_year',output_csv + 'branch_flows/')
    #             save_csv(bus_voltage_df,f'bus_voltage_df_{kind}_year',output_csv + 'bus_voltage/')
    #             save_csv(bess_powers,f'bess_powers_{kind}_year',output_csv + 'bess/')
